<div class="row">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text"
            class="form-control @error('passport_full_name') is-invalid @enderror"
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text"
            class="form-control @error('passport_issued_from') is-invalid @enderror"
            name="passport_issued_from"
            value="{{ old('passport_issued_from') }}"
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text"
            class="form-control datepicker @error('passport_issued_date') is-invalid @enderror"
            name="passport_issued_date"
            value="{{ old('passport_issued_date') }}"
    ...
    <div class="col-md-4 mb-3">
        <label class="form-label">Expiry Date</label>
                            <div class="position-relative">
        <input type="text"
            class="form-control datepicker @error('passport_expiry_date') is-invalid @enderror"
