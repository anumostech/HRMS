        ...
        <div class="row">
            <div class="col-md-12 mb-2">
                <div class="select-wrapper">
                    <select class="form-control @error('visa_type') is-invalid @enderror" name="visa_type"
                        id="visaTypeSelect">
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="hidden" name="visa_page" value="{{ old('visa_page', $employee->visa_page ?? '') }}">
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="hidden" name="labor_card" value="{{ old('labor_card', $employee->labor_card ?? '') }}">
                @if(isset($employee) && $employee->labor_card)
                <small class="text-success"><i class="fe fe-check-circle"></i> File uploaded</small>
                @endif
            </div>
            <div class="col-md-12 mb-3">
                <label class="form-label">Attach Labor Contract</label>
                <input type="file" class="form-control mb-1 document-upload" data-field="labor_contract" accept=".pdf,.jpg,.jpeg,.png">
                <input type="hidden" name="labor_contract" value="{{ old('labor_contract', $employee->labor_contract ?? '') }}">
                @if(isset($employee) && $employee->labor_contract)
                <small class="text-success"><i class="fe fe-check-circle"></i> File uploaded</small>
                @endif
            </div>
