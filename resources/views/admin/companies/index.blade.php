                                        ...
                                        <td>
                                            @if($company->logo)
                                                <img src="{{ asset('storage/' . $company->logo) }}" alt="Logo"
                                                    class="avatar avatar-sm rounded-circle shadow-sm" style="object-fit:cover;">
                                            @else
                                                <div
                                                    class="avatar avatar-sm rounded-circle bg-light text-muted d-flex align-items-center justify-content-center">
