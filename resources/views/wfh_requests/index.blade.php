    ...
    <div class="row w-100">
        <div class="col-lg-12 mx-auto">
            <div class="page-header mt-4 mb-4" style="display:inline">
                <h1 class="page-title mb-2">Work From Home Requests</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Work From Home Requests</li>
                    </ol>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($req->status == 'Pending')
                                                <form action="{{ route('wfh_requests.status', $req->id) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
