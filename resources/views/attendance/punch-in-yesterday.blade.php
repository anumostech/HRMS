...
<div class="page-header" style="display: inline;">
    <h1 class="page-title mb-2">Punched In Yesterday</h1>
    <div>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Attendance</a></li>
            <li class="breadcrumb-item active" aria-current="page">Punched In Yesterday</li>
        </ol>
    </div>
</div>
<!-- PAGE-HEADER END -->
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">Punched In Yesterday</h3>
            </div>
            <div class="card-body">

                <form action="{{ route('attendance.punchInYesterday') }}" method="GET" class="mb-4">
