        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('attendance.upload') }}" class="btn btn-primary"><svg
                            xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="white" viewBox="0 0 16 16">
                            <path
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="employee_name" id="employee_name" class="form-control"
                                    placeholder="Search name..." value="{{ request('employee_name') }}">
                            </div>
                            <div class="col-md-2">
                                ...
                                <div class="select-wrapper">
                                    <select name="date_preset" id="date_preset" class="form-control"
                                        ...
                                        <option value="today" {{ request('date_preset') == 'today' ? 'selected' : '' }}>Today
                                        </option>
                                        ...
                                        <option value="custom" {{ request('date_preset') == 'custom' ? 'selected' : '' }}>
                                            Custom</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-2 custom-date-range"
                                style="display: {{ request('date_preset') == 'custom' ? 'block' : 'none' }};">
